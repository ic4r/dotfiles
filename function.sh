...
function extract() {
    if [ -f $1 ] ; then
        case $1 in
            ...
            *.Z)         uncompress $1  ;;
            *.7z)        7z x $1        ;;
        *)     echo -e "'$1' cannot be extracted via extract()" ;;
        esac
    else
...
#-------------------------------------------------------------------------------
# Shell function chestsheet - https://github.com/appkr/dotfiles/blob/master/functions.sh
#-------------------------------------------------------------------------------
# $* : all args
# $# : number of args
